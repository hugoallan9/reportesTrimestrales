...
public class Transito extends Documento{
    ...
    protected ArrayList cargarCapitulo1(){
        ...
        seccion1.add("Eventos de tránsito");
        ...
        seccion1.add("Distribución porcentual de los eventos de tránsito,"
        ...
        seccion2.add("Distribución porcentual de los eventos de tránsito, "
                + "según día de la semana de ocurrencia");
        ...
        seccion2.add("Distribución porcentual de los eventos de tránsito, según tipo de evento");
        seccion2.add(formatoTrimestre + "en porcentaje" );
        ...
        seccion3.add("Distribución de los vehículos involucrados en eventos de "
                + "tránsito, según el tipo");
        ...
        seccion4.add("Distribución de los conductores involucrados en eventos de "
                + "tránsito, según el sexo");
        ...
        seccion5.add("Distribución de los conductores involucrados en eventos de "
        ...
        seccion5.add("Conductores que manejaban ebrios, involucrados en eventos de tránsito");
    ...
    protected ArrayList cargarCapitulo2(){
        ...
        seccion1.add("Distribución de las víctimas de eventos de tránsito, "
                + "según el estado de la víctima");
        seccion1.add(formatoTrimestre + "en porcentaje");
        ...
        seccion2.add("Víctimas fallecidas por eventos de tránsito");
        ...
        seccion2.add("Distribución de las víctimas fallecidas por eventos "
                + "de tránsito, según departamento de ocurrencia");
        seccion2.add(formatoTrimestre + "en porcentaje");
        ...
        seccion3.add("Distribución de las víctimas fallecidas por eventos de tránsito, "
                + "según sexo");
        seccion3.add(formatoTrimestre + "en porcentaje");
        ...
        seccion4.add("Víctimas lesionadas por eventos de tránsito");
        ...
        seccion4.add("Distribución de las víctimas lesionadas por eventos de tránsito, "
                + "según departamento de ocurrencia");
        seccion4.add(formatoTrimestre + "en porcentaje");
        ...
        seccion5.add("Distribución de las víctimas lesionadas por eventos de tránsito, "
                + "según sexo");
        seccion5.add(formatoTrimestre + "en porcentaje");
    ...
    protected ArrayList cargarCapitulo3(){
        ...
        ArrayList seccion1 = new ArrayList();
        seccion1.add("3_01");
        seccion1.add("Eventos de tránsito con víctimas atropelladas");
        seccion1.add("Eventos de tŕansito con víctimas atropelladas");
        seccion1.add(formatoSerie + "en unidades");
        seccion1.add("3_01.tex");
        seccion1.add("INE, con datos de Policía Nacional Civil");
        seccion1.add(true);
        seccion1.add("3_02");
        seccion1.add("Eventos con atropello, según departamento");
        seccion1.add("Distribución de los eventos de tránsito con víctimas "
                + "atropelladas, según departamento de ocurrencia");
        seccion1.add(formatoTrimestre + "en porcentaje");
        ...
        ArrayList seccion2 = new ArrayList();
        seccion2.add("3_03");
        seccion2.add("Víctimas atropelladas según día de la semana");
        seccion2.add("Distribución de los eventos de tránsito con víctimas"
                + " atropelladas, según día de ocurrencia de la semana");
        seccion2.add(formatoTrimestre + "en porcentaje");
        seccion2.add("3_03.tex");
        seccion2.add("INE, con datos de Policía Nacional Civil");
        seccion2.add(true);
        seccion2.add("3_04");
        seccion2.add("Víctimas atropelladas por tipo de vehículo");
        seccion2.add("Distribución de los eventos de tránsito con víctimas "
                + "atropelladas, según tipo de vehículo involuctrado");
        seccion2.add(formatoTrimestre + "en porcentaje");
        ...
        seccion3.add("Distribución de los conductores  involucrados en eventos de "
                + "tránsito con atropello, según condición de ebriedad");
        seccion3.add(formatoTrimestre + "en porcentaje");
        ...
        ArrayList seccion4 = new ArrayList();
        seccion4.add("3_07");
        seccion4.add("Atropellados fallecidos según departamento");
        seccion4.add("Distribución de las víctimas fallecidas por atropello, "
                + "según departamento de ocurrencia");
        seccion4.add(formatoTrimestre + "en porcentaje");
        ...
        seccion4.add(true);
        seccion4.add("3_08");
        seccion4.add("Atropellados fallecidos según sexo");
        seccion4.add("Distribución de las víctimas fallecidas por atropello, según sexo");
        seccion4.add(formatoTrimestre + "en porcentaje");
        ...
        ArrayList seccion5 = new ArrayList();
        seccion5.add("3_09");
        seccion5.add("Atropellados fallecidos según grupo de edad");
        seccion5.add("Distribución de las víctimas fallecidas por atropello, según "
                + "grupo de edad");
        seccion5.add(formatoTrimestre + "en porcentaje");
        ...
        seccion5.add(true);
        seccion5.add("3_10");
        seccion5.add("Atropellados fallecidos según grupo de edad y sexo");
        ...
        seccion6.add("Víctimas lesionadas por atropello");
        ...
        seccion6.add("Distribución de las víctimas lesionadas por atropello, según "
        ...
        seccion7.add("Distribución de las víctimas lesionadas por atropello, según sexo");
        ...
        seccion7.add("Distribución de las víctimas lesionadas por atropello, según grupo "
                + "de edad");
        seccion7.add(formatoTrimestre + "en porcentaje");
