 ...
 * @author INE
 */
public class AnualHospitalaria extends Documento{
    ...
    public AnualHospitalaria(String titulo, String trimestre, String pYear, String rutaCSV){
    ...
    protected void setCapitulos(){
        capitulos.add("Atenciones externas: características generales");
        capitulos.add("Atenciones externas: causas principales y especiales");
        capitulos.add("Atenciones internas: características generales");
        capitulos.add("Atenciones internas: causas principales y especiales");
    ...
    private void section1_01() {
        escribirLinea("\n \n %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%HOJA %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% \n\n");
        escribirLinea(seccion( "1_01","Atenciones en hospitales privados en los años recientes", 
                "descripcion201",
                "Número de personas atendidas en servicios externos en hospitales privados",
                "Serie histórica",
    ...
    private void section1_02() {
        escribirLinea("\n \n %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%HOJA %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% \n\n");
        escribirLinea(seccion( "1_02","Atenciones según el mes", 
                "descripcion201",
                "Servicios externos prestados durante el 2013",
                "Distribución mensual, en porcentaje",
    ...
    private void section1_03() {
        escribirLinea("\n \n %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%HOJA %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% \n\n");
        //aqui van dos graficas en una misma página
        //pedir a Hugo la seccion/tabla/mapa para generar dicha seccion
        
        /*
        
        escribirLinea(seccion( "1_03","Atenciones por lugar de residencia", 
                "descripcion201",
                "Atenciones ",
    ...
    private void section1_05() {
        escribirLinea("\n \n %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%HOJA %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% \n\n");
        escribirLinea(seccion( "1_05","Atenciones según sexo", 
                "descripcion201",
                "Servicios externos prestados durante el " +getYear(),
                "Distribución por ",
