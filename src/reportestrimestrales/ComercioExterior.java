...
public class ComercioExterior extends Documento{
    ...
    protected ArrayList cargarCapitulo1(){
        ...
        seccion1.add("Exportaciones totales trimestrales");
        seccion1.add(formatoSerie + "cifras en miles de millones de dólares");
        seccion1.add("1_01.tex");
        seccion1.add("INE, con datos del BANGUAT");
        seccion1.add(true);
        seccion1.add("1_02");
        seccion1.add("Variación interanual de las exportaciones");
        seccion1.add("Variación interanual de las exportaciones totales");
        seccion1.add(formatoSerie + "en porcentaje");
        ...
        seccion2.add("Importaciones totales trimestrales");
        seccion2.add(formatoSerie + "cifras en miles de millones de dólares");
        seccion2.add("1_03.tex");
        seccion2.add("INE, con datos del BANGUAT");
        seccion2.add(true);
        seccion2.add("1_04");
        seccion2.add("Variación Interanual de las importaciones");
        seccion2.add("Variación interanual de las importaciones totales");
        ...
        seccion3.add("Balanza comercial general trimestral");
        seccion3.add(formatoSerie + "cifras en miles de millones de dólares");
        ...
        seccion3.add("Balanza comercial relativa");
        seccion3.add(formatoSerie + "cantidad adimensional");
        ...
        seccion4.add("Balanza comercial de Guatemala por continente");
        seccion4.add(formatoTrimestre + "cifras en millones de dólares");
        seccion4.add("1_07.tex");
        seccion4.add("INE, con datos del BANGUAT");
        seccion4.add(true);
        seccion4.add("1_08");
        seccion4.add("Balanza comercial con Centroamérica");
        seccion4.add("Balanza comercial de Guatemala con el mercado común Centroamericano");
        seccion4.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion5.add("Principales productos de exportación en el Comercio Total");
        seccion5.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion5.add("Principales destinos de exportaciones guatemaltecas");
        seccion5.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion6.add("Exportaciones según las principales secciones del SAC");
        seccion6.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion7.add("Principales países de origen de las importaciones");
        seccion7.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion7.add("Importaciones según las principales secciones del SAC");
        seccion7.add(formatoTrimestre + "cifras en millones de dólares");
    ...
    protected ArrayList cargarCapitulo2(){
        ...
        seccion1.add("Exportaciones trimestrales por comercio territorio aduanero");
        seccion1.add(formatoSerie + "cifras en miles de millones de dólares");
        ...
        seccion1.add("2_02");
        seccion1.add("Variación interanual de las exportaciones");
        seccion1.add("Variación porcentual interanual de las exportaciones por territorio aduanero");
        seccion1.add(formatoSerie + "en porcentaje");
        ...
        seccion2.add("Importaciones trimestrales por comercio territorio aduanero");
        seccion2.add(formatoSerie + "cifras en miles de millones de dólares");
        ...
        seccion2.add("2_04");
        seccion2.add("Variación Interanual de las importaciones");
        seccion2.add("Variación porcentual interanual de las importaciones por comercio territorio aduanero");
        seccion2.add(formatoSerie + "en porcentaje");
        ...
        seccion3.add("Balanza comercial trimestral del territorio aduanero");
        seccion3.add(formatoSerie + "cifras en miles de millones de dólares");
        ...
        seccion4.add("2_07");
        seccion4.add("Balanza comercial por continente");
        seccion4.add("Balanza comercial del comercio territorio aduanero por continente");
        seccion4.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion4.add("2_08");
        seccion4.add("Balanza comercial con Centroamérica");
        seccion4.add("Balanza comercial del territorio aduanero con el mercado común centroamericano");
        seccion4.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion5.add("2_09");
        seccion5.add("Principales productos de exportación");
        seccion5.add("Principales productos de exportación por territorio aduanero");
        seccion5.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion5.add("2_10");
        seccion5.add("Exportaciones según los principales países de destino");
        seccion5.add("Principales países de exportaciones guatemaltecas por territorio aduanero");
        seccion5.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion6.add("2_11");
        seccion6.add("Principales exportaciones según secciones SAC");
        seccion6.add("Exportaciones por territorio aduanero según las principales secciones del SAC");
        seccion6.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion6.add("2_12");
        seccion6.add("Principales productos de importación");
        seccion6.add("Principales productos de importación por territorio aduanero");
        seccion6.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion7.add("2_13");
        seccion7.add("Importaciones según los principales países de origen");
        seccion7.add("Principales países de origen de las importaciones por territorio aduanero");
        seccion7.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion7.add("2_14");
        seccion7.add("Principales importaciones según secciones del SAC");
        seccion7.add("Importaciones por territorio aduanero según las principales secciones del SAC");
        seccion7.add(formatoTrimestre + "cifras en millones de dólares");
    ...
    protected ArrayList cargarCapitulo3(){
        ...
        seccion1.add("Exportaciones trimestrales por Comercio Decreto 29-89");
        seccion1.add(formatoSerie + "cifras en millones de dólares");
        seccion1.add("3_01.tex");
        seccion1.add("INE, con datos del BANGUAT");
        seccion1.add(true);
        seccion1.add("3_02");
        seccion1.add("Variación interanual de las exportaciones");
        seccion1.add("Variación porcentual interanual de las exportaciones por Comercio Decreto 29-89");
        seccion1.add(formatoSerie + "en porcentaje");
        ...
        seccion2.add("Importaciones trimestrales por comercio Decreto 29-89");
        seccion2.add(formatoSerie + "cifras en millones de dólares");
        seccion2.add("3_03.tex");
        seccion2.add("INE, con datos del BANGUAT");
        seccion2.add(true);
        seccion2.add("3_04");
        seccion2.add("Variación Interanual de las importaciones");
        seccion2.add("Variación porcentual interanual de las importaciones por comercio Decreto 29-89");
        seccion2.add(formatoSerie + "en porcentaje");
        ...
        seccion3.add("Balanza comercial trimestral del Decreto 29-89");
        seccion3.add(formatoSerie + "cifras en millones de dólares");
        seccion3.add("3_05.tex");
        seccion3.add("INE, con datos del BANGUAT");
        seccion3.add(true);
        seccion3.add("3_06");
        seccion3.add("Balanza comercial relativa del Decreto 29-89");
        seccion3.add("Balanza comercial relativa del comercio por Decreto 29-89");
        seccion3.add(formatoSerie + "cantidad adimensional");
        ...
        seccion4.add("3_07");
        seccion4.add("Balanza comercial por continente");
        seccion4.add("Balanza comercial comercio Decreto 29-89 por continente");
        seccion4.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion4.add("3_08");
        seccion4.add("Balanza comercial con Centroamérica");
        seccion4.add("Balanza comercial del Decreto 29-89 con el mercado común centroamericano");
        seccion4.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion5.add("3_09");
        seccion5.add("Principales productos de exportación");
        seccion5.add("Principales productos de exportación por Decreto 29-89");
        seccion5.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion5.add("3_10");
        seccion5.add("Exportaciones según los principales países de destino");
        seccion5.add("Principales países de exportaciones guatemaltecas por Decreto 29-89");
        seccion5.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion6.add("3_11");
        seccion6.add("Principales exportaciones según secciones SAC");
        seccion6.add("Exportaciones por Decreto 29-89 según las principales secciones del SAC");
        seccion6.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion6.add("3_12");
        seccion6.add("Principales productos de importación");
        seccion6.add("Principales productos de importación por Decreto 29-89");
        seccion6.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion7.add("3_13");
        seccion7.add("Importaciones según los principales países de origen");
        seccion7.add("Importación por Decreto 29-89 según los principales países");
        seccion7.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion7.add("3_14");
        seccion7.add("Principales importaciones según secciones del SAC");
        seccion7.add("Importaciones por Decreto 29-89 según las principales secciones del SAC");
        seccion7.add(formatoTrimestre + "cifras en millones de dólares");
    ...
    protected ArrayList cargarCapitulo4(){
        ...
        seccion1.add("Exportaciones trimestrales por Comercio Zonas Francas");
        seccion1.add(formatoSerie + "cifras en millones de dólares");
        ...
        seccion1.add("4_02");
        seccion1.add("Variación interanual de las exportaciones");
        seccion1.add("Variación interanual de las exportaciones por Comercio Zonas Francas");
        seccion1.add(formatoSerie + "en porcentaje");
        ...
        seccion2.add("Importaciones trimestrales por comercio Zonas Francas");
        seccion2.add(formatoSerie + "cifras en millones de dólares");
        ...
        seccion2.add("4_04");
        seccion2.add("Variación Interanual de las importaciones");
        seccion2.add("Variación porcentual interanual de las importaciones por comercio Zonas Francas");
        seccion2.add(formatoSerie + "en porcentaje");
        ...
        seccion3.add("Balanza comercial trimestral de Zonas Francas");
        seccion3.add(formatoSerie + "cifras en millones de dólares");
        ...
        seccion3.add("Balanza comercial relativa del comercio Zonas Francas");
        seccion3.add(formatoSerie + "cantidad adimensional");
        ...
        seccion4.add("4_07");
        seccion4.add("Balanza comercial por continente");
        seccion4.add("Balanza comercial del comercio por Zonas Francas por continente");
        seccion4.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion4.add("4_08");
        seccion4.add("Balanza comercial con Centroamérica");
        seccion4.add("Balanza comercial de Zonas Francas con el mercado común centroamericano");
        seccion4.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion5.add("4_09");
        seccion5.add("Principales productos de exportación");
        seccion5.add("Principales productos de exportación por comercio de Zonas Francas");
        seccion5.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion5.add("4_10");
        seccion5.add("Exportaciones según los principales países de destino");
        seccion5.add("Principales países de destino de las exportaciones guatemaltecas por comercio de Zonas Francas");
        seccion5.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion6.add("4_11");
        seccion6.add("Principales exportaciones según secciones SAC");
        seccion6.add("Exportaciones por comercio Zonas Francas según las principales secciones del SAC");
        seccion6.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion6.add("4_12");
        seccion6.add("Principales productos de importación");
        seccion6.add("Principales productos de importación por comercio Zonas Francas");
        seccion6.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion7.add("4_13");
        seccion7.add("Importaciones según los principales países de origen");
        seccion7.add("Importaciones por comercio de Zonas Francas según los principales países");
        seccion7.add(formatoTrimestre + "cifras en millones de dólares");
        ...
        seccion7.add("4_14");
        seccion7.add("Principales importaciones según secciones del SAC");
        seccion7.add("Importaciones por comercio de Zonas Francas según las principales secciones del SAC");
        seccion7.add(formatoTrimestre + "cifras en millones de dólares");
